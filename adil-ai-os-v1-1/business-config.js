export const business = {
  ...
  packages: [
    { id: 'basic', name: 'Basic', price: 199, bestFor: 'simple projects, landing pages and customers starting small' },
    { id: 'standard', name: 'Standard', price: 499, bestFor: 'growing businesses that need a stronger business presence and more features' },
